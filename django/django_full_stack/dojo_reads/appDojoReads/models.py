...
class User(models.Model):
    ...
    #reviewed_book is manytomany related name - users can favorite many books, and many books can have many favorites
...
class BookManager(models.Manager):
    def basic_validator(self, requestPOST):
        ...
        if len(requestPOST['review']) < 5:
            errors['review_too_short'] = "Review is too short"
...
class Book(models.Model):
    ...
    users_who_review = models.ManyToManyField(User, related_name = "reviewed_book")
